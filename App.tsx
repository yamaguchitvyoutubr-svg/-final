  ...
  return (
    <div className="min-h-screen bg-black text-slate-200 flex flex-col items-center p-4 md:p-8 relative overflow-y-auto overflow-x-hidden font-sans">
      ...
      <div className="fixed bottom-6 right-6 flex gap-3 z-50 opacity-40 hover:opacity-100 transition-opacity duration-300">
        ...
        <button onClick={() => setIsMusicOpen(!isMusicOpen)} title="Audio Terminal" className={`p-3 rounded-full border transition-all ${isMusicOpen ? 'bg-cyan-500 border-cyan-400 text-black shadow-[0_0_15px_rgba(6,182,212,0.5)]' : 'bg-gray-900/80 border-slate-700 text-slate-400 hover:border-cyan-500/50 hover:text-white'}`}>
        ...
        <button onClick={() => fileInputRef.current?.click()} title="Quick Asset Import" className="text-slate-400 hover:text-white p-3 rounded-full border border-slate-700 bg-gray-900/80 transition-all hover:border-cyan-500/50">
